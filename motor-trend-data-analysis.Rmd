...
### Plot Impact of Transmission Type on Fuel Consumption
...
between the two parameters (transmission type and fuel consumption) to
to include other possible variables that explain variance in fuel consumption
(MPG). This will be performed in the remaining sections.
