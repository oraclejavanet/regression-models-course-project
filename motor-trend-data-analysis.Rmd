...
kable(summary(mtcars[1]),
              row.names = FALSE,
              align = c("l"),
              caption = "Target Variable (MPG)") %>% kable_styling(position = "center")

# independent control variables
kable(summary(mtcars[2:6]),
              row.names = FALSE,
              align = c(rep("l", 5)),
              caption = "Control Variables") %>% kable_styling(position = "left")
kable(summary(mtcars[7:11]),
              row.names = FALSE,
              align = rep('l', 5),
              caption = "Control Variables (cont)") %>% kable_styling(position = "left")
```
