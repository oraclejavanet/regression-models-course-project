...
manual transmissions automobiles by
...
1. Automobiles with a manual transmission yield better gas mileage than vehicles
   ...
   will achieve `r round(t1$estimate[1])` MPG on average compared to
   `r round(t1$estimate[2])` MPG for an automatic
   transmission giving us a mean difference of
   `r round(t1$estimate[2] - t1$estimate[1])` MPG favoring a manual
   transmission.
